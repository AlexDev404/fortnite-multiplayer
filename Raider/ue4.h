...
static void InitInventory(AFortPlayerController* PlayerController)
{
    ...
    static auto Trap1 = UObject::FindObject<UFortTrapItemDefinition>("FortTrapItemDefinition TID_Floor_Player_Launch_Pad_Athena.TID_Floor_Player_Launch_Pad_Athena");
    ...
    AddItem(PlayerController, Trap1, 1, EFortQuickBars::Secondary, 1);
